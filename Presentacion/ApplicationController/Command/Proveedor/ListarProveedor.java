...
*/
public class ListarProveedor implements Comando {
	/** 
	* (non-Javadoc)
	...
	*/
	public Context execute(Object data) {
		...
		SAProveedor sprov = FactoriaSA.getInstance().creaSAProveedor();
		ArrayList<TProveedor> provs = sprov.listarProveedores();
		Context context = new Context();
		if(provs == null)
			context.setEvent(Eventos.ListarProveedores_Error);
		else
			context.setEvent(Eventos.ListarProveedores_Exito);
